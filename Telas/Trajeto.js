...
import user from "../assets/condutor.png"
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Marker coordinate={gpsPonto1} image={require("../assets/ponto.png")} />
        <Marker
          coordinate={gpsPonto2}
          image={require("../assets/ponto.png")}
        />
        <Marker
          coordinate={gpsPonto3}
          image={require("../assets/ponto.png")}
        />
      </MapView>
